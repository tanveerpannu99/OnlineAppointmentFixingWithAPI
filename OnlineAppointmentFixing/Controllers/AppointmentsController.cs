...
namespace OnlineAppointmentFixing.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ServiceID,CustomerID,SlotTimeID,Date")] Appointment appointment)
        {
            ...
            ViewBag.ServiceID = new SelectList(db.Services, "ID", "ServiceName", appointment.ServiceID);
            return View(appointment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ServiceID,CustomerID,SlotTimeID,Date")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
